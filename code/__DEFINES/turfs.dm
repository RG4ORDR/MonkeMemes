...
#define CHANGETURF_DEFAULT_BASETURF (1<<7) /// Use the baseturfs of the provided type
#define CHANGETURF_GENERATE_SHUTTLE_CEILING (1<<8) // Generate a shuttle ceiling on the above turf
